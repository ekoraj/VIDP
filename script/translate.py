...
def main():
    # dossier_videos = os.path.join(os.getcwd(), "/VIDP/data")
    # dossier_langues = os.path.join(os.getcwd(), "./../data/lang-detect")
    # dossier_sous_titres = os.path.join(os.getcwd(), "./../data/sous_titres_output")

    dossier_videos = os.path.join(os.getcwd(), "/VIDP/data")
    dossier_langues = os.path.join(os.getcwd(), "/VIDP/data/lang-detect")
    dossier_sous_titres = os.path.join(os.getcwd(), "/VIDP/data/sous_titres_output")

    videos = [f for f in os.listdir(dossier_videos) if f.endswith(('.mp4', '.avi'))]
